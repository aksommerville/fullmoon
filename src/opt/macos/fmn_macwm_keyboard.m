...
int fmn_macwm_translate_keysym(int key) {
  switch (key) {
...
int fmn_macwm_report_buttons_keyboard(
  //struct fmn_input_device *device,void *userdata,int (*cb)(struct fmn_input_device *device,const struct fmn_input_btncfg *btncfg,void *userdata)
) {
//  if (!cb) return -1;
  #define _(tag,loword) /*if (fmn_macwm_rptbtn(device,userdata,cb,0x0007##loword,0,2)<0) return -1;*/
  //TODO delegate
    _(ANSI_A,0004)
    _(ANSI_B,0005)
    _(ANSI_C,0006)

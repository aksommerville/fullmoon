...
macos_CCDEF:=$(patsubst %,-DFMN_USE_%=1,$(macos_OPT_ENABLE)) -DFMN_IMAGE_SET_$(macos_IMAGE_SET)=1 -DFMN_FRAMEBUFFER_$(macos_FBFMT)=1 -DFMN_QUITTABLE=1
...
macos_DATA_SRC:=$(filter-out %.adjust,$(macos_DATA_SRC))
...
$(macos_MIDDIR)/%.mid.c:src/%.mid src/%.adjust $(TOOL_songcvt);$(PRECMD) $(TOOL_songcvt) -o$@ -i$<
